...
### Duplicate the Repository (Create Your Own Copy)

If you want to create a completely independent duplicate of this repository under your own GitHub account:
...
3. Clone your forked repository:
   ```bash
   git clone https://github.com/YOUR-USERNAME/Secure-Renewals-2.git
   cd Secure-Renewals-2
   ```

**Option 2: Mirror Clone (Complete independent copy)**
```bash
# 1. Create a bare clone of the repository
git clone --bare https://github.com/ismaelloveexcel/Secure-Renewals-2.git

# 2. Create a new empty repository on GitHub (via github.com or gh cli)
# Then mirror-push to your new repository
cd Secure-Renewals-2.git
git push --mirror https://github.com/YOUR-USERNAME/YOUR-NEW-REPO-NAME.git

# 3. Remove the temporary bare clone
cd ..
rm -rf Secure-Renewals-2.git
